 ...
 * @since 1.0.0
 */
class CoBlocks_Click_To_Tweet_Notices {
	...
	public function notice() {
		...
		printf(
			...
			esc_html( 'CoBlocks Click to Tweet Block' ),
			esc_html( 'CoBlocks' ),
			esc_url( $this->plugin_action_link( 'click-to-tweet-gutenberg/class-coblocks-click-to-tweet.php', 'deactivate' ) )
		);
	}
}

return new CoBlocks_Click_To_Tweet_Notices();
