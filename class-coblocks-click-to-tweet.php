 ...
 * @since 1.0.0
 */
class CoBlocks_Click_To_Tweet {

	/**
	 * This plugin's instance.
	 *
	 * @var CoBlocks_Click_To_Tweet
	 */
	...
	public static function register() {
		if ( null === self::$instance ) {
			self::$instance = new CoBlocks_Click_To_Tweet();
	...
	private function __construct() {
		...
		add_filter( 'plugin_action_links_' . plugin_basename( plugin_dir_path( __FILE__ ) . 'class-coblocks-click-to-tweet.php' ), array( $this, 'plugin_action_links' ) );
	}
	...
	public function includes() {
		require_once 'includes/class-coblocks-click-to-tweet-notices.php';
	}
	...
	public function plugin_row_meta( $input, $file ) {
		...
		if ( 'click-to-tweet-gutenberg/class-coblocks-click-to-tweet.php' !== $file ) {
			return $input;
		}
...
CoBlocks_Click_To_Tweet::register();
